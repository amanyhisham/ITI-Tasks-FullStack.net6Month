...
# 🎓 ITI – Full Stack .NET Development Program
...
| # | Course / Topic | Folder |
|---|-----------------|--------|
| 1 | Prompt Engineering | `GenAI-PromptEngineer` |
| 2 | Retrieval-Augmented Generation (RAG) | `GenAI-PromptEngineer` |
| 3 | AI Agents Development | `GenAI-PromptEngineer` |
| 4 | Fine-Tuning Concepts | `GenAI-PromptEngineer` |
| 5 | Vibe Coding with AI Tools | `GenAI-PromptEngineer` |
| 6 | AI Tools Discovery | `GenAI-PromptEngineer` |
...
| # | Course / Topic | Folder |
|---|-----------------|--------|
| 1 | Presentation Skills | `Presentation Skills` |
| 2 | Testing Fundamentals | `Testing` |
| 3 | CV Writing | `WorkShops` |
| 4 | Workplace Ethics | `WorkShops` |
